...
class SSASideMenu: UIViewController, UIGestureRecognizerDelegate {
    ...
    struct ContentViewEffect {
        ...
        var minParallaxContentRelativeValue: Float = -30.0
        var maxParallaxContentRelativeValue: Float = 30.0
        var interactivePopGestureRecognizerEnabled: Bool = true
        
        init(alpha: Float = 1.0, scale: Float = 0.7, landscapeOffsetX: Float = 30, portraitOffsetX: Float = 30, minParallaxContentRelativeValue: Float = -30.0, maxParallaxContentRelativeValue: Float = 30.0, interactivePopGestureRecognizerEnabled: Bool = true) {
    ...
    func _presentLeftMenuViewController() {
        ...
        let color = StatusBarUtils.hexStringToUIColor(hex: "#ea0c85")
